...
_.typeOf = function(anything){
    if(anything === 'string') return 'string';
    if(Array.isArray(anything)) return 'array';
    if(anything instanceof Date) return 'number';
...
_.first = function(array, number){
    ...
    if(number === undefined || isNaN(number || number === 1)) return array[0];
...
_.partition = function(array, func){
  ...
  _.reject(array, function(value, index, array){
      if(func(value, index, array)){
          trueArr.push(value);
      }
      else {
...
_.map = function(collection, func){
    ...
    _.each(collection, function(value, index, array){
       newArr.push(func(value, index, array));
...
_.every = function(collection, action){
    ...
    _.each(collection, function(element, index, array){
        ...
        else if(!action(element, index, array)){
            result = false;
        }
    });
...
_.reduce = function(array, action, seed){
  ...
  _.each(array, function(value, index, array){
      if (index > 0 || seedExist){
      previous = action(previous, value, index);
...
_.extend = function(object1, object2, object3, object4){
    
    Object.assign(object1, object2,object3, object4);
