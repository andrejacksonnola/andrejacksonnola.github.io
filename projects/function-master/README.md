...
//console.log(typeof a);
 ...
 - null === null // checks if null is strictly equal to null, which is like an empty container
 normally something that had a value before but the value was manually taken away
